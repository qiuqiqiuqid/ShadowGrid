...
最新版本：**v1.2.1** (2026-03-15)

### V1.2.1 重要更新
- **新增功能**：
  - 新增大文件传输功能 - 自动检测大文件并切换到流式传输
  - 支持传输进度、文件大小、速度等信息显示
  - 流式分块上传/下载机制，适合大文件传输
  - **新增** 完整的文件完整性校验 - 所有大小文件传输后自动验证数据完整性
  - **新增** 美观的进度条动画 - 对所有文件大小提供流畅动画进度条
...
- **系统改进**：
  ...
  - 优化find命令实现，修复潜在异常
  - 改进错误处理和用户反馈体验
  - **优化** ASCII艺术进度条动画 - 为小文件传输提供视觉上更吸引人的界面
  - **改进** 文件完整性验证 - 自动校验上传/下载文件的MD5哈希值确保数据准确
