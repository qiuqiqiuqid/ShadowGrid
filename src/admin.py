...
# [已禁用] # [已禁用]     # [已禁用] # [已禁用] print(f"  {YELLOW}history{RESET}           {LGREEN}查看命令历史{RESET}")
# [已禁用] # [已禁用]     # [已禁用] # [已禁用] print(f"  {YELLOW}history -c{RESET}        {LGREEN}清除命令历史{RESET}")
# [已禁用] # [已禁用]     # [已禁用] # [已禁用] print(f"  {YELLOW}!!{RESET}                {LGREEN}执行上一条命令（待完善）{RESET}")
